...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .hint { font-size: 12px; color: var(--bs-secondary-color); }
    .panes {
      display: flex;
      flex: 1;
      min-height: 0;
    ...
    .entry-result { color: #20c997; white-space: pre-wrap; word-break: break-word; }
    .entry-error { color: #dc3545; white-space: pre-wrap; word-break: break-word; }
    .entry-print { color: #0dcaf0; white-space: pre-wrap; word-break: break-word; }
    @media (max-width: 575.98px) {
      .toolbar .btn { flex: 1 0 auto; }
      .hint { width: 100%; order: 2; }
    }
  </style>
</head>
<body>
  <nav class="navbar border-bottom py-1">
    <div class="container-fluid px-3 d-flex flex-wrap align-items-center gap-2">
      <span class="navbar-brand fw-bold mb-0 fs-6">Glaze - Filo REPL</span>
      <span class="small text-muted">interactive desktop evaluator</span>
    </div>
  </nav>
  ...
  <main class="main-wrap">
    <div class="workspace">
      ...
      <div class="statusbar">
        <span>Bindings: filo_eval and filo_reset</span>
        <span>Filo extensions: math, str, rand, print</span>
      </div>
    </div>
  </main>
